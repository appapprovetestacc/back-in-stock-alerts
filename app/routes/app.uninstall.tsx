...
export function loader({ context }: LoaderFunctionArgs) {
  ...
  return Response.json({
    app: "Back in Stock Alerts",
    steps: [
      "Revoke OAuth access and stop background jobs for the shop.",
      "Uninstall " + "Back in Stock Alerts" + " from Shopify admin > Settings > Apps and sales channels.",
      "Verify the mandatory shop/redact webhook fired and completed data cleanup.",
    ],
    dataRetention:
      "Back in Stock Alerts" + " deletes or anonymizes shop data after uninstall and shop/redact processing. The standard deletion SLA is 30 days.",
