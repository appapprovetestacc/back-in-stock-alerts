...
export const meta: MetaFunction = () => [
  { title: "Back in Stock Alerts" },
  {
    name: "description",
    content:
      "Back in Stock Alerts is a Shopify App that runs inside your store's admin. Install via Shopify admin → Apps to enable it on your storefront.",
  },
];
    ...
    >
      ...
      >
        ...
        <p style={{ margin: "0 0 1.75rem", color: "#666", fontSize: "0.95rem", lineHeight: 1.5 }}>
          Install on your Shopify store to start using Back in Stock Alerts.
        </p>
